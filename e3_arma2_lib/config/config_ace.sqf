...
//Affichage du temps avant mort 
ace_sys_wounds_prevtimeshow = true;
publicVariable "ace_sys_wounds_prevtimeshow";
// <-> à vérifier laquel est la bonne 
ace_wounds_prevtimeshow = true;
publicVariable "ace_wounds_prevtimeshow";

// Désactivation du rpunish
ace_sys_wounds_no_rpunish = true;
publicVariable "ace_sys_wounds_no_rpunish";

//Desactivation du soin ACE pour les I.A. 
...
// ? Réparation des pneus ... ( à vérifier exactement le rôle)
